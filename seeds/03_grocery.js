  ...
  return knex('grocery').del()
    .then(function () {
      return Promise.all([
        ...
        knex('grocery').insert({name: 'IGA', location: '909 Burrard St', notes: 'Talk to Joe at the counter.', email: 'iga@email.com', phone_number: '(604) 605-0612', picture:'https://igav3-metcdn-com.global.ssl.fastly.net/content/uploads/2016/10/19231144/iga-australia-logo.png'}),
